...
public record SimpleItem(Item item, int meta, NBTTagCompound nbt) {
    ...
    private static final Reference2ObjectMap<Item, Int2ObjectMap<Map<NBTTagCompound, SimpleItem>>> chane = Reference2ObjectMaps
        .synchronize(new Reference2ObjectOpenHashMap<>());
    private static final Reference2ObjectFunction<Item, Int2ObjectMap<Map<NBTTagCompound, SimpleItem>>> intMap = i -> Int2ObjectMaps
