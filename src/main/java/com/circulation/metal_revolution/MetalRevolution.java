...
@Mod(
    modid = MetalRevolution.MOD_ID,
    name = "MetalRevolution",
    version = MetalRevolution.VERSION,
    acceptedMinecraftVersions = "[1.7.10]",
    dependencies = "required-after:manametalmod@[7.4.5,);" + "required-after:unimixins@[0.1.23,);"
