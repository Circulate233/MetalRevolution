...
@Mixin(BlockTileEntityMetalReduction.class)
public abstract class MixinBlockMetalReduction extends BlockContainer {

    protected MixinBlockMetalReduction(Material Material) {
        super(Material);
    }
