...
public class MixinBedrockCrusher {
    ...
    static {
        m$valid[0] = item -> BedrockCrusherRecipes.smelting().getSmeltingResult((ItemStack) item) != null;
